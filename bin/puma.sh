...
case "$1" in
  start)
    ...
    if [ -e $PUMA_CONFIG_FILE ] ; then
      echo "cd $APP_DIR && RAILS_ENV=$RAILS_ENV bundle exec pumactl -P /home/ubuntu/NurseWorks/shared/tmp/pids/puma.pid -F /home/ubuntu/NurseWorks/shared/puma.rb" >> /tmp/puma.log
      /bin/su - $USER -c "cd $APP_DIR && RAILS_ENV=$RAILS_ENV bundle exec pumactl -P /home/ubuntu/NurseWorks/shared/tmp/pids/puma.pid -F /home/ubuntu/NurseWorks/shared/puma.rb" >> /tmp/puma.log
    else
