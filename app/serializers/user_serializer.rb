class UserSerializer < ActiveModel::Serializer
  ...
  :image, :can_manage, :verified, :bank_account, :rating, :user_docs, :push_token,
  ...
  :avail_full_time , :currently_permanent_staff, :part_time_work_days, :payment_option, :upi, :profile_pic
